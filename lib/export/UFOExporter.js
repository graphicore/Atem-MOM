...
define([
  ...
  , timer
    ...
    _p.exportGenerator = regeneratorRuntime.mark(function callee$1$0(glyphNames) {
        var master, glyphs, glyphSet, glyph, drawFunc, glifData, i, l, time, one, total;

        return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
                master = this._master, total = 0;
