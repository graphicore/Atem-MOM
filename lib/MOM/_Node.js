  ...
  , cpsTools
    ...
    _p.loadData = function(data) {
        ...
        if('attachedData' in data)
            // serialize then deserialize to break most probably unwanted
            // shared references with other users of data.attachedData
            this.attachData(JSON.parse(JSON.stringify(data.attachedData)));
    };
