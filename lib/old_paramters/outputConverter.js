  ...
  , parseSelectorList
    ...
    rules.push(
      ...
      , new Rule(
          ...
          , parameterDictFromObject({
                // 'defaults.cps' ...
                // these will be set by the importer
                , width: '0'
                , height: '0'
              })
          , source
      ...
      , new Rule(
          ...
          , parameterDictFromObject({
                  // This could be in a more generic 'defaults.cps'
      ...
      , new Rule(
          ...
          , parameterDictFromObject({
                ...
                , 'in': 'tension2controlIn pointBefore:on pointBefore:outDir inTension inDir on'
                , out: 'tension2controlOut on outDir outTension pointAfter:inDir pointAfter:on'
                // TODO: Maybe, as in contour>p we should calculate the tension values
                // here from inLength and outLength. Then the importer would
                // have less to take care off and the overal setup is more unified.
