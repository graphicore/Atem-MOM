  ...
  , yaml
    ...
    _p._getUFOReader = obtain.factory(
        {
          ...
          , ufoReader:[false, 'io', 'path', UFOWriter.factory]
        }
      , {
            ufoReader:[true, 'io', 'path', UFOWriter.factory]
        }
      , []
    ...
    _p._writeYAMLFile = function(async, path, obj) {
        ...
        if(async)
            return promise.then(this._io.writeFile
                              .bind(this._io, true, path, yaml));
        return this._io.writeFile(false, path, yaml);
    };
    ...
    _p.deleteCPSFile = function(async, filename, skipNoEntry) {
        ...
        try {
            ...
            if(skipNoEntry && error === IONoEntryError)
                return;
            throw error;
        }
    };
