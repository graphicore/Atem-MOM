    ...
    _p.getZippedInstance = obtain.factory(
        {
          ...
          , ufoExporter: [false, 'io', 'masterName', 'targetDirName', 'precision', _p._getUFOExporter]
      ...
      , {
            ufoExporter: [true, 'io', 'masterName', 'targetDirName', 'precision', _p._getUFOExporter]
          , zip: [true, 'exportedIo', 'targetDirName', 'dataType', zipUtil.pack]

        }
      , ['masterName', 'targetDirName', 'precision', 'dataType']
