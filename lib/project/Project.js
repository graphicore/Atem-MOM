  ...
  , metapolationGenerator
    ...
    */
    ...
    _p.ufoImporterFactory = function (async, sourceUFODir, io, log) {
        ...
        var ufoReader = UFOReader.factory(async, io || this._plainIO, sourceUFODir)
          , glyphGroups = this._getGlyphGroups(async)
          , options = {classes: glyphGroups}
          ;
        return UFOImporter.factory(async, log || this._log, ufoReader, options);
    };
     ...
     * Returns a Promise
     */
    _p._unpackZippedUFOMasters = function(mem_io) {
    ...
    _p.unpackImportBlob = function (blob, masterNamePrefix) {
        var memIo = new InMemory();
        return zipUtil.unpack(true, blob, memIo, '')
                      .then(this._unpackZippedUFOMasters.bind(this, memIo))
